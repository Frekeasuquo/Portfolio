...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_sk8wqp5', 'template_y5ygrpk', formRef.current, 'eyTYMfLRtEsysecpP')
            .then((result) => {
                setSuccess(true)
            }, (error) => {
                setError(true)
        ...
        <motion.div className='contact' variants={variants} initial="initial" whileInView='animate'>
            <motion.div className='textContainer' variants={variants}>
                ...
                <motion.div className='item' variants={variants}>
                    <h2>Mail</h2>
                    <span>asuquondifreke06@gmail</span>
                </motion.div>
                <motion.div className='item' variants={variants}>
                    <h2>Address</h2>
